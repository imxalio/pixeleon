  ...
  return (
    <div className="bg-violet-50">
      <div className="max-w-screen-xl mx-auto md:py-20 py-16 px-7">
        ...
        <p className="text-xl mb-7 md:w-3/6">
          ...
          {team.map((person) => {
            return person.name ? (
              ...
              >
                ...
                <h2 className="font-semibold text-2xl mb-3">{person.name}</h2>
                <h3 className="font-medium text-xl font-semibold text-violet-800">
                  {person.position}
                </h3>
              </div>
            ) : (
